...
// Custom Prompts (versioned format: { version, prompts }; shortcuts are optional per prompt)
pref("customPrompts", '{ "version": 2, "prompts": [ { "title": "Organize my recent additions into collections", "text": "Review the papers I added in the last two weeks. Check what collections I have, then help me file these items into the appropriate existing collections based on their topics.", "librarySearch": false, "requiresAttachment": false, "shortcut": 1 }, { "title": "Review and fix metadata", "text": "Check my 10 most recently added items for missing or incomplete metadata especially DOIs for journal articles, publication info, and abstracts. Look up the correct information and help me fix any issues.", "librarySearch": false, "requiresAttachment": false, "shortcut": 2 }, { "title": "Find related work in my library", "text": "What papers in my library are most relevant to this one? Identify similar methodologies, topics, or findings and explain the connections.", "librarySearch": true, "requiresAttachment": true, "shortcut": 3 }, { "title": "Highlight and annotate key findings", "text": "Add highlight annotations to the most important findings, evidence, and conclusions. Include brief notes explaining why each section matters.", "librarySearch": false, "requiresAttachment": true, "requiresDatabaseSync": true, "shortcut": 4 }, { "title": "Compare this to other studies", "text": "How do the findings here compare to similar research in my library? Identify agreements, contradictions, and gaps.", "librarySearch": true, "requiresAttachment": true, "shortcut": 5 } ] }');
