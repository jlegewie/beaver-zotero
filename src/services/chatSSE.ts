...
export async function requestChatCompletion(
    ...
    const { backendUrl, threadId, userMessageId, assistantMessageId, content } = params;
 ...
 */
function handleXHRError(xhr: XMLHttpRequest, onError: (err: string) => void) {
