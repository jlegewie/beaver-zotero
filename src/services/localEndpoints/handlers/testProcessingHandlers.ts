...
import { resetLocalProcessingState } from '../../backgroundProcessing/resetLocalState';
 ...
 * decides whether anything runs at all — instance entitlements, the prefs, and the
