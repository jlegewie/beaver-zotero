 ...
 *   - Authenticated, with user library (1) and group library (2) synced.
 *   - Fixtures NORMAL_PDF (1-2YWA8DTZ) and GROUP_LIB_PDF (2-WTY4J27Q) seeded
 *     with cached page-0 geometry (headless annotation creation needs it).
 *
