...
describe('citationGrammar', () => {
    it('parses registered locator prefixes and ranges', () => {
        ...
        expect(parseLoc('l3-l5')).toEqual({ kind: 'line', value: '3-5', raw: 'l3-l5' });
    ...
    it('does not map line locators into the PDF citation index before line entries exist', () => {
        expect(citationIndexCandidateIdsForLocator(parseLoc('l34')!)).toEqual([]);
        expect(citationIndexCandidateIdsForLocator(parseLoc('l3-l5')!)).toEqual([]);
    });
