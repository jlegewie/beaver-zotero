...
type SidebarLeftIconProps = React.SVGProps<SVGSVGElement>;

const SidebarLeftIcon: React.FC<SidebarLeftIconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
        ...
        <path d="M9.5 3L9.5 21" strokeLinejoin="round"></path>
        <path d="M5 7H6M5 10H6" strokeLinecap="round" strokeLinejoin="round"></path>
    </svg>
