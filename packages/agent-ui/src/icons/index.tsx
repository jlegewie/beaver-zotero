// The shared icon set. Consumers import from `@beaver/agent-ui/icons`; a single
// icon can also be imported by its own subpath (`@beaver/agent-ui/icons/Spinner`)
// when only one is needed.
//
// Client-specific icons are not here: a Zotero CSS icon or a
// `chrome://zotero/skin/...` image only renders inside a Zotero window, so those
// stay in the client and are merged in by the client's own icon barrel.
