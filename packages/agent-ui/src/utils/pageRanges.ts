/**
 * Page-range display formatting for citation locators.
 *
 * Both formatters collapse consecutive pages into ranges; they differ only in
 * whether the range boundaries are rendered as raw page numbers or as the
 * printed page labels resolved for those pages.
 */
