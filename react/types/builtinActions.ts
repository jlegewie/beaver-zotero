...
export const BUILTIN_ACTIONS: Action[] = [
...

    {
        ...
        text: 'Find notable research I should know about.\n\nFocus: if I named a topic or question, use that. Otherwise, infer what I am currently working on from my most recent additions. If there are multiple plausible topics, ask me to select from plausible choices.\n\nUse external search to find notable work in this area, prioritizing a mix of recent papers (last 2-3 years) and influential work I appear to be missing. Return up to 10 papers ranked by relevance. For each, give authors (year), title, and one sentence on why it matters to me. Clearly mark the ones already in my library, and cite the rest as external references so I can add the ones I want.\n\nDo not add anything to my library — just present the list.\n\n**Smith (2019)**\n Title of reference\n *Name of Journal*\n Citations: X (if available)\n [1-2 sentence on relevant and why important including citation to the item]\n [list all references]\n **Recap**: [very short recap of what you found like "I found X new reference that focus on… Smith (2025) and Mueller (2026) are particularly relevant..."]',
