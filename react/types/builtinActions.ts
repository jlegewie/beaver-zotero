 ...
 * - `targets` lists every context kind the action accepts; prompts that read
 *   naturally for both regular items and standalone attachments declare both.
 * - sortOrder groups by primary target and ranks by expected frequency of use.
