...
type FolderDetailIconProps = React.SVGProps<SVGSVGElement>;

const FolderDetailIcon: React.FC<FolderDetailIconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M22 15H15M22 18H15M17.5 21H15" />
    </svg>
);

export default FolderDetailIcon;