...
type FileViewIconProps = React.SVGProps<SVGSVGElement>;

const FileViewIcon: React.FC<FileViewIconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M16 22C18.7614 22 21 19 21 19C21 19 18.7614 16 16 16C13.2386 16 11 19 11 19C11 19 13.2386 22 16 22Z" />
        <path d="M15.9902 19H15.9992" />
    </svg>
);
