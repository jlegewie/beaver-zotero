...
import { CheckmarkCircleIcon, CancelCircleIcon, Icon, Spinner, ThreeIcon, OneIcon, TwoIcon, AlertIcon as AlertIconIcon, InformationCircleIcon as InformationCircleIconIcon } from "../icons/icons";
...
export const AlertIcon = <Icon icon={AlertIconIcon} className="font-color-yellow scale-14" />;
