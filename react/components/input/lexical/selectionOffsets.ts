 ...
 * Element-point endpoints are retained so blank-line carets can be restored
 * structurally when the destination editor has the same tree shape.
 */
export function $getFlatSelectionOffsets(): ComposerSelection | null {
...
/** Restore flattened offsets, preserving direction and element points. */
export function $selectFlatSelection(selectionOffsets: ComposerSelection): void {
