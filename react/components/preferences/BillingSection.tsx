            ...
            <div className="display-flex flex-row gap-3">
                {subscriptionPlans.map((plan) => {
                    ...
                    return (
                        <div
                            key={plan.sku}
                            className="display-flex flex-1 flex-col rounded-md border-card bg-senary p-4"
                        >
...
const BillingSection: React.FC = () => {
    ...
    return (
        <>
            ...
            {/* --- Section 1: Plan Card --- */}
            <div className="display-flex flex-col rounded-lg overflow-hidden border-card bg-senary p-5">
                {isPastDue && (
                    <div
