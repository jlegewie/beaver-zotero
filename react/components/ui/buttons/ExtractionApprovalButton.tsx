...
interface ExtractionApprovalButtonProps {
 ...
 */
const ExtractionApprovalButton: React.FC<ExtractionApprovalButtonProps> = ({
    onAlwaysApprove,
}) => {
    ...
    return (
        <MenuButton
            ...
            ariaLabel="Extraction approval preference"
            tooltipContent="How to handle extraction cost confirmations"
            showArrow={false}
        />
    );
};

export default ExtractionApprovalButton;
